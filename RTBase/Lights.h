...
public:
	...
	Vec3 sceneCentre;
	float sceneRadius;
	void init(Vec3 center, float radius)
	{
		sceneCentre = center;
		sceneRadius = radius;
		bounds.init(center, radius);
	}
};
...
public:
	...
	Vec3 sample(Sampler* sampler, Color& emittedColour, float& pdf)
	{
...
public:
	...
	Vec3 sample(Sampler* sampler, Color& reflectedColour, float& pdf)
	{
